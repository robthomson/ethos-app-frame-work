...
local MSP_API_STRUCTURE_READ_DATA = {
    { field = "minthrottle",                 type = "U16", apiVersion = {12, 0, 6}, simResponse = {45, 4},  unit="us", min = 50,   max = 2250, default = 1070},
    { field = "maxthrottle",                 type = "U16", apiVersion = {12, 0, 6}, simResponse = {208, 7},  unit="us",  min = 50,   max = 2250, default = 2000},
    { field = "mincommand",                  type = "U16", apiVersion = {12, 0, 6}, simResponse = {232, 3},  unit="us",  min = 50,   max = 2250, default = 1000},
    { field = "motor_count_blheli",          type = "U8",  apiVersion = {12, 0, 6}, simResponse = {1}},
    { field = "motor_pole_count_blheli",     type = "U8",  apiVersion = {12, 0, 6}, simResponse = {6}},

    { field = "use_dshot_telemetry",         type = "U8",  apiVersion = {12, 0, 6}, simResponse = {0},  table = onoff, tableIdxInc = -1},
    ...
    { field = "use_unsynced_pwm",            type = "U8",  apiVersion = {12, 0, 6}, simResponse = {1}, table = onoff, tableIdxInc = -1},

    { field = "motor_pole_count_0",          type = "U8",  apiVersion = {12, 0, 6}, simResponse = {6},  min = 2,   max = 256,  step = 2, default = 10},
