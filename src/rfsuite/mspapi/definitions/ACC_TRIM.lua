...
local MSP_API_STRUCTURE_READ_DATA = {
    { field = "pitch", type = "S16", apiVersion = {12, 0, 6}, simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°"},
    { field = "roll",  type = "S16", apiVersion = {12, 0, 6}, simResponse = {0, 0}, min = -300, max = 300, default = 0, unit = "°"},
}
-- LuaFormatter on
