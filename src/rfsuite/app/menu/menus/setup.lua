return {
    ...
    items = {
        ...
        {id = "servos", title = "@i18n(app.modules.servos.name)@", subtitle = "Servo outputs and setup", loaderSpeed = 0.08, kind = "menu", source = "app/menu/menus/servos.lua", image = "app/modules/servos/servos.png"},
        {id = "esc_motors", title = "@i18n(app.modules.esc_motors.name)@", subtitle = "ESC programming and motor setup", loaderSpeed = 0.08, kind = "menu", source = "app/menu/menus/esc_motors.lua", image = "app/modules/esc_tools/esc.png"},
