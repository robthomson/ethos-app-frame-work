return {
    ...
    items = {
        ...
        {id = "diagnostics", title = "Diagnostics", subtitle = "Transport and sensor diagnostics", kind = "menu", source = "app/menu/menus/diagnostics.lua", image = "app/modules/diagnostics/diagnostics.png", offline = true}
    }
}
