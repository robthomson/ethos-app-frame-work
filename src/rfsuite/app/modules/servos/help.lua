...
data.help = {
    default = {
        "@i18n(app.modules.servos.help_default_p1)@",
        "@i18n(app.modules.servos.help_default_p2)@",
        "@i18n(app.modules.servos.help_default_p3)@"
    },
    servos_tool = {
        "@i18n(app.modules.servos.help_tool_p1)@",
        "@i18n(app.modules.servos.help_tool_p2)@",
        "@i18n(app.modules.servos.help_tool_p3)@",
        "@i18n(app.modules.servos.help_tool_p4)@",
        "@i18n(app.modules.servos.help_tool_p5)@",
        "@i18n(app.modules.servos.help_tool_p6)@"
    }
}
