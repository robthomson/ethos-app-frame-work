...
local FIELDS = {
    {t = "@i18n(app.modules.esc_tools.mfg.omp.gov)@", activeFieldPos = 2, type = 1, apikey = "governor"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.gov_p)@", activeFieldPos = 6, apikey = "gov_p"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.gov_i)@", activeFieldPos = 7, apikey = "gov_i"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.motor_poles)@", activeFieldPos = 17, apikey = "motor_poles"}
}
