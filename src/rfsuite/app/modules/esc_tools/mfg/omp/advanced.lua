...
local FIELDS = {
    {t = "@i18n(app.modules.esc_tools.mfg.omp.timing)@", activeFieldPos = 4, type = 1, apikey = "timing"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.acceleration)@", activeFieldPos = 9, type = 1, apikey = "acceleration"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.brake_force)@", activeFieldPos = 14, apikey = "brake_force"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.sr_function)@", activeFieldPos = 15, type = 1, apikey = "sr_function"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.capacity_correction)@", activeFieldPos = 16, apikey = "capacity_correction"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.auto_restart_time)@", activeFieldPos = 10, type = 1, apikey = "auto_restart_time"},
    {t = "@i18n(app.modules.esc_tools.mfg.omp.cell_cutoff)@", activeFieldPos = 11, type = 1, apikey = "cell_cutoff"}
}
...
function Page:open(ctx)
    ...
    local page = MspPage.create({
        title = "@i18n(app.modules.esc_tools.mfg.omp.advanced)@",
        subtitle = ctx.item.subtitle or "@i18n(app.modules.esc_tools.mfg.omp.name)@",
        eepromWrite = true,
        api = {
            {name = "ESC_PARAMETERS_OMP", rebuildOnWrite = true}
        },
        loaderOnEnter = {
