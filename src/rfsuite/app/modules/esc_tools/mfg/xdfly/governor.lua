...
local FIELDS = {
    {t = "@i18n(app.modules.esc_tools.mfg.xdfly.gov)@", activeFieldPos = 2, type = 1, apikey = "governor"},
    {t = "@i18n(app.modules.esc_tools.mfg.xdfly.gov_p)@", activeFieldPos = 6, apikey = "gov_p"},
    {t = "@i18n(app.modules.esc_tools.mfg.xdfly.gov_i)@", activeFieldPos = 7, apikey = "gov_i"},
    {t = "@i18n(app.modules.esc_tools.mfg.xdfly.motor_poles)@", activeFieldPos = 17, apikey = "motor_poles"}
}
...
function Page:open(ctx)
    ...
    local page = MspPage.create({
        title = "@i18n(app.modules.esc_tools.mfg.xdfly.governor)@",
